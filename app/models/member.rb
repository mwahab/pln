class Member < ActiveRecord::Base
  ...
  attr_accessible :firstName, :lastName, :birthdate, :gender, :address, :city, :province, :postalCode, :telephone, :carecard, :sin, :ethnicity, :diagnosis, :arv, :arvDate, :doctor, :dentist, :doctorPhone, :dentistPhone, :placeDiagnosis, :dateDiagnosis 
